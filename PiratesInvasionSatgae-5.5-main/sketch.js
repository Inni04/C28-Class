...
function draw() {
  background(189);
  image(backgroundImg, 0, 0, width, height); //! is NOT
  ...
  fill("#6d4c41");
  textSize(40);
  text(`Score:${score}`, width - 200, 50); //dollar sign is a particular property that keeps updating, used to get the attributes
...
function gameOver() {
  swal(       //swal is a predefined alert, has been imported
    {
      title: `Game Over!!!`,
